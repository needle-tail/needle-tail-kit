...
#if (os(macOS) || os(iOS))
        await messenger.plugin.emitter.requestMessageId = messageId
#endif
    }
...
#if (os(macOS) || os(iOS))
        await clearNewDeviceState(messenger.plugin.emitter)
#endif
    }
        ...
        for recipient in recipients {
            ...
            case .nick(_):
                ...
                case .ack(let ack):
                    ...
                    await store.setAck(ack.acknowledgment)
                    ...
                    } else if await store.acknowledgment == .quited {
