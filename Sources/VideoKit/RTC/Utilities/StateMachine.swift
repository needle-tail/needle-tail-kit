...
internal enum StateMachine: CustomStringConvertible {
    case disconnected
    case connecting
    case registering(channel: Channel, nick: String, userInfo: IRCUserInfo)
    case registered (channel: Channel, nick: String, userInfo: IRCUserInfo)
    case error      (VideoErrors)
    case requestedQuit
    case quit
    ...
    var description : String {
        ...
        case .registering(_, let name, _): return "registering<\(name)>..."
        case .registered (_, let name, _): return "registered<\(name)>"
