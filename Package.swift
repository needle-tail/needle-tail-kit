...
let package = Package(
    ...
    targets: [
        ...
        dependencies: [
            ...
            .product(name: "CypherMessaging", package: "CypherTextKit", condition: .when(platforms: [.iOS, .android, .macCatalyst, .tvOS, .macOS])),
            .product(name: "MessagingHelpers", package: "CypherTextKit", condition: .when(platforms: [.iOS, .android, .macCatalyst, .tvOS, .macOS])),
